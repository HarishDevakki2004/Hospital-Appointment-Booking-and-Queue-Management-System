...
// Countdown timer component (separate component to use hooks properly)
...
const MyAppointments = () => {
  ...
  return (
    <motion.div
      ...
      className="min-h-screen w-full bg-gradient-to-br from-gray-50 to-gray-100 dark:from-[#0f172a] dark:to-[#1e293b] py-12 px-4 sm:px-6 lg:px-8 pb-20 md:pb-12"
    >
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            {appointments.map((item, index) => {
              ...
              const userToken = item.slotTokenIndex || item.tokenNumber;
                        ...
                        <div className="flex-1">
                          ...
                          {userToken && (
                            <div className="mb-4 space-y-2">
                              ...
                              {/* Countdown Timer */}
                              {item.estimatedStart && (
                                <CountdownTimer targetTime={item.estimatedStart} />
                              )}

                              {item.estimatedWaitTime !== null && item.estimatedWaitTime !== undefined && !item.estimatedStart && (
